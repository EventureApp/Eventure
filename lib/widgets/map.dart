...
class MapWidget extends StatefulWidget {
  ...
  const MapWidget({super.key, required this.currentLocation, this.currentSelectedLocation});
...
class _MapWidgetState extends State<MapWidget> {
  ...
  void _onLocationChanged() {
    final newLocation = Provider.of<LocationProvider>(context, listen: false).currentSelectedLocation;
    if (newLocation != null && newLocation != _currentSelectedLocation && _isMapReady) {
      setState(() {
        _currentSelectedLocation = newLocation;
      });
      _mapController.move(_currentSelectedLocation!, _mapController.camera.zoom);
    }
  }
